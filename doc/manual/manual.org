...
For example, pale red squares spread along a column represent processors at varying degrees of utilization.
A dark red square at the top of a column shows many processors at close to 100% utilization.
Inversely, a dark red square at the bottom of a column means that many processors are near-idle.

A more in-depth explanation is available from
[[https://www.brendangregg.com/HeatMaps/utilization.html#heatmaps][Brendan Gregg's blog post on quantized heatmaps]].

  ...
  \startsection[title=Main window]
    ...
    \startsubsection[title={Activities, tracks, and spans}]
      ...
      \startsubsubsection[title={Span colors}]
        Spans in processor activities will have one of two colors:
        ...
        Spans in the first track of goroutine activities can have many different colors, representing the many different states a goroutine can be in.

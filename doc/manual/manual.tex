...
Clicking on a goroutine scrolls the canvas to the corresponding timeline.
Holding \keys{\shortcut} while clicking on a goroutine zooms to it.
Holding \keys{\shift} while clicking on a goroutine opens a goroutine panel.
Right-clicking on a goroutine opens a context menu with all navigation options.

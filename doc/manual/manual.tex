...
Clicking on a goroutine will scroll the canvas to the corresponding timeline.
Right-clicking on a goroutine opens a context menu that allows scrolling or zooming to the goroutine, as well as opening a goroutine panel.

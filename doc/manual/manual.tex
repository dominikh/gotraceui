...
\begin{itemize}
\item Clicking on one scrolls the canvas to the corresponding timeline.
\item Holding \keys{\shortcut} while clicking on one zooms to it.
\item Holding \keys{\shift} while clicking on one opens the corresponding panel.
\end{itemize}

The context menu of span links allows scrolling to their beginnings or ends.

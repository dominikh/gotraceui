...
% XXX update colors
\definecolor{stateActive}{HTML}{4A8E4A}
\definecolor{stateBlockedGC}{HTML}{B55A79}
\definecolor{stateBlockedHappensBefore}{HTML}{DB7A75}
\definecolor{stateBlockedNet}{HTML}{C9716C}
\definecolor{stateBlockedSyscall}{HTML}{B95B57}
\definecolor{stateBlocked}{HTML}{A94C49}
\definecolor{stateGC}{HTML}{8A68B8}
\definecolor{stateInactive}{HTML}{7C7C7C}
\definecolor{stateReady}{HTML}{008F9F}
\definecolor{stateStuck}{HTML}{000000}
\definecolor{stateUserRegion}{HTML}{F8ABEE}
\definecolor{stateStack}{HTML}{7DBC7B}
\definecolor{stateSampled}{HTML}{A1DB9F}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{images/screenshots/#1}
  \caption{#2}
\end{figure}}
...
Finally, clicking \menu{Tabify} will turn a panel into a tab (see \cref{tabs} for more information on tabs).

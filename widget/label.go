// Modified copy of gio.org/widget.Label that supports
// - hiding the truncator if it'd be the only thing visible
...
type Label struct {
	...
	Truncator string
	// Don't print the truncator if it'd be the only visible part of the label.
	HideIfEntirelyTruncated bool
}
